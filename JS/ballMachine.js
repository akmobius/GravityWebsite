//this is a library for animating a ball under gravity
//parameters is an object with the following properties
// svg: svg root object to which we will add the ball
// balls: [{x: 50, y: 100, r: 15, mass: 1, color: rgb(255,0,0)},{x: 100, y: 100, r: 20, mass: 2, color: rgb(0,255,0)}],
// ground: 400  "ground" (where motion stops)
