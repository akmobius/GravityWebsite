...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 13 16:04:46 2020

@author: francknongzanga
"""
...
""" 
This function assigns the appropriate texture given the mass put by the user. """
#Here we just need to define the ranges: depending on the range we will know what kind of texture to apply.
def getTexture(mass):
    if mass <= 2e30:
        return textures.stucco
    if(mass >=2e30):
        return "https://s3.amazonaws.com/glowscript/textures/flower_texture.jpg"
    
    
    

#Here I set an explicit mass but can change based on input. 
def body(position: "vector",rad: "metres",mass: "kg", texture= getTexture(2e31), angle= 0.01,axis= vector(0,1,0)) -> "body":
    """ 
